...
describe('Costumer unit tests', () => {
  ...
  it('should throw error when id is empty', () => {
    expect(() => {
      const costumer = new Costumer('', 'Filho da puta')
    }).toThrowError('Id is required')
  })

  it('should throw error when name is empty', () => {
    expect(() => {
      const costumer = new Costumer('123', '')
  ...
  it('should change name', () => {
    expect(() => {
      // Arrange
      const costumer = new Costumer('123', 'John')
      // Act
  ...
  it('should activate costumer', () => {
    expect(() => {
      const costumer = new Costumer('1234', 'Costumer 1')
